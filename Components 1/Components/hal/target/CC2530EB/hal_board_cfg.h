...
/* S1 */
#define KEY1_BV          BV(4)
#define KEY1_SBIT        P0_4
#define KEY1_POLARITY    ACTIVE_LOW
/* S2 */
#define KEY2_BV          BV(5)
#define KEY2_SBIT        P0_5
#define KEY2_POLARITY    ACTIVE_LOW
/* S3 */
#define KEY3_BV          BV(6)
#define KEY3_SBIT        P0_6
#define KEY3_POLARITY    ACTIVE_LOW
/* S4 */
#define KEY4_BV          BV(7)
#define KEY4_SBIT        P0_7
#define KEY4_POLARITY    ACTIVE_LOW
...
/* ----------- Push Buttons ---------- */
#define HAL_PUSH_BUTTON1()        (KEY1_POLARITY (KEY1_SBIT))
#define HAL_PUSH_BUTTON2()        (KEY2_POLARITY (KEY2_SBIT))//(PUSH2_POLARITY (PUSH2_SBIT))
#define HAL_PUSH_BUTTON3()        (KEY3_POLARITY (KEY3_SBIT))//(0)
#define HAL_PUSH_BUTTON4()        (KEY4_POLARITY (KEY4_SBIT))//(0)
...
/* ----------- LED's ---------- */
  ...
  #define HAL_TOGGLE_LED4()         st( if (LED3_SBIT) { LED4_SBIT = 0; } else { LED4_SBIT = 1;} )
